  ...
  "use strict";
	...
	var Rewall = {
		...
		colorScheme: function(){
			...
			scheme.find('.separator').text('https://frenify.net/');
		...
		contactForm: function(){
			$('#send_message').on('click', function(){
				...
				if(name === ''|| email === ''|| message === '' || emailto === ''){
					...
					{
						if(e.ok) {
							spanSuccess.append("Thank you for getting in touch! \n");
							spanSuccess.append("<p class='contact_success'>I appreciate you contacting us. I will get back in touch with you soon! Have a great day! </p>");
